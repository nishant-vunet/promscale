...
func ParseFlags(fs *flag.FlagSet, cfg *Config) *Config {
	...
	fs.Uint64Var(&cfg.LabelsCacheSize, "metrics.cache.labels.size", 100000, "Maximum number of labels to cache.")
	...
	fs.Uint64Var(&cfg.InvertedLabelsCacheSize, "metrics.cache.inverted-labels.size", 500000, "Maximum number of label-ids to cache. Inverted lables cache reduces the number of DB calls when ingesting new series.")
	return cfg
}
